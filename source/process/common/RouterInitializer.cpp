 ...
 * @date Created <2014-04-25 15:22:29>
 *
...
void initializeDriverRouter(::izenelib::driver::Router& router, IService* service, bool enableTest)
{
...

    {
        ...
        handler_ptr load_clusteringHandler(
            new handler_type(
                laser,
                &LaserController::load_clustering
            )
        );
        ...
        router.map(
            controllerName,
            "load_clustering",
            load_clusteringHandler.get()
        );
        load_clusteringHandler.release();
