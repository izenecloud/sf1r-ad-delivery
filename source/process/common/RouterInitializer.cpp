 ...
 * @date Created <2014-06-11 19:14:14>
 *
...
void initializeDriverRouter(::izenelib::driver::Router& router, IService* service, bool enableTest)
{
...

    {
        ...
        handler_ptr set_ad_bid_phraseHandler(
            new handler_type(
                ad,
                &AdController::set_ad_bid_phrase
            )
        );
        ...
        router.map(
            controllerName,
            "set_ad_bid_phrase",
            set_ad_bid_phraseHandler.get()
        );
        set_ad_bid_phraseHandler.release();
        ...
        handler_ptr set_keyword_bidpriceHandler(
            new handler_type(
                ad,
                &AdController::set_keyword_bidprice
            )
        );
